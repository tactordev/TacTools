...
export default function Overview({ tabs, setTabs }: { tabs: Tab[]; setTabs: (tabs: Tab[]) => void; }) {
    ...
    const day = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"][new Date().getDay()];
    ...
    return (
        <div className="flex flex-row mx-12 my-4 w-full">
            <div className="flex flex-col mx-12 my-4 min-w-96 w-full max-w-2xl">
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center mt-12">
                        ...
                        <p className="text-base font-semibold text-gray-500/60 mt-2">No tasks due.</p>
                    </div>
                ) : (
                    <>
            ...
            <div className="flex flex-row w-full">
                <Day type={day} events={events} setEvents={setEvents} showEventCtxMenu={showEventCtxMenu} offsetDate={monDate} />
            </div>
        </div>
    );
};